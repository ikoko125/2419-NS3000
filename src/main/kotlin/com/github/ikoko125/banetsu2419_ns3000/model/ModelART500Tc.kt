...
object ModelART500Tc {
    ...
    fun registerObjects(renderer: VehiclePartsRenderer) {
        models[renderer.modelName] = PartsRegistry().apply {
            ...
            listOf(
                this::body to listOf("face", "InFace", "ExFace", "obj1", "obj2", "obj3"),
    ...
    internal class PartsRegistry {
        ...
        internal var aOff: Parts by LateInitOnce()
        internal var aOffB: Parts by LateInitOnce()
    }
}
